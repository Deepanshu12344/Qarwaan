...
export const FALLBACK_TRIPS: Trip[] = [
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival and Srinagar Local', description: 'Pickup, check-in, evening shikara ride and lakeside dinner.' },
      { day: 2, title: 'Gulmarg Day Tour', description: 'Cable car experience, meadow walks, return to Srinagar.' },
      { day: 3, title: 'Pahalgam Excursion', description: 'Valley drive, riverside picnic spots, local market time.' },
      { day: 4, title: 'Breakfast and Departure', description: 'Morning free time, assisted checkout, airport drop.' },
    ],
    featured: true,
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival and Marina Walk', description: 'Airport pickup, check-in, guided evening walk around marina.' },
      { day: 2, title: 'City Landmarks', description: 'Museum of the Future, Dubai Mall, Burj Khalifa.' },
      { day: 3, title: 'Desert Safari', description: 'Dune bashing, camp dinner and cultural performances.' },
      { day: 4, title: 'Leisure and Shopping', description: 'Flexible day for beach or shopping with coordinator support.' },
      { day: 5, title: 'Departure', description: 'Breakfast and transfer for return travel.' },
    ],
    featured: true,
  },
  {
    ...
    itinerary: [
      { day: 1, title: 'Arrival in Phuket', description: 'Hotel check-in and evening old town orientation.' },
      { day: 2, title: 'Phi Phi Islands', description: 'Full-day boat tour with lunch and snorkeling halts.' },
      { day: 3, title: 'Transfer to Krabi', description: 'Road transfer and evening leisure in Ao Nang.' },
      { day: 4, title: 'Krabi Island Tour', description: 'Visit key islands and beach activities.' },
      { day: 5, title: 'Free Exploration', description: 'Optional excursions and local cafes.' },
      { day: 6, title: 'Return to Phuket', description: 'Transfer back and final shopping time.' },
      { day: 7, title: 'Departure', description: 'Checkout and airport transfer support.' },
    ],
    featured: true,
  },
  {
